...
function buyArtifact(id) {
  ...
  if (state.gold >= cost) {
    ...
    else state.artifacts.push({ id: artDef.id, name: artDef.name, icon: artDef.icon, rarity: artDef.rarity, level: 1, basePrice: artDef.basePrice, desc: artDef.desc });
