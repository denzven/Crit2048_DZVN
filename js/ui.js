...
function renderSidebar() {
  ...
  if (state.playerClass.ability) {
    el.btnAbility.classList.remove('hide'); el.btnAbilityMobile.classList.remove('hide');
    el.sidebarSpellInfo.classList.remove('hide'); el.sidebarClassUses.classList.remove('hide');
    ...
    el.btnAbility.classList.add('hide'); el.btnAbilityMobile.classList.add('hide');
    el.sidebarClassUses.classList.add('hide'); el.sidebarSpellInfo.classList.add('hide');
  }
