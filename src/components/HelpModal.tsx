  ...
  return (
    <div className="absolute inset-0 z-[150] flex flex-col items-center justify-center p-4 md:p-8">
      ...
      >
        ...
        <button
          onClick={onClose}
          className="absolute top-4 right-4 text-slate-400 hover:text-white text-3xl font-light z-10"
        >
          &times;
        </button>
        <h2 className="text-3xl font-black tracking-widest mb-2 text-rose-500 text-center uppercase font-serif shrink-0">
          Compendium
        </h2>
        ...
        <div className="flex-grow space-y-6 text-slate-300 text-sm relative overflow-y-auto pr-2 pb-4 custom-scrollbar">
          {currentPage === 1 && (
            <div className="animate-in fade-in slide-in-from-right-4 duration-300">
              <h3 className="text-xl font-bold text-white mb-3 uppercase tracking-widest border-b border-slate-700 pb-2">
                I. Quick Start Guide
              </h3>
              <p className="mb-4">
                <strong>Welcome to Crit 2048!</strong> Here is everything you need to know to
                survive your first run:
              </p>
              <ul className="list-disc pl-5 space-y-4 text-slate-300">
                <li>
                  <strong className="text-white">The Goal:</strong> Defeat all bosses before you run
                  out of moves (slides).
                </li>
                <li>
                  <strong className="text-white">How to Attack:</strong> Swipe to slide the tiles.
                  When two identical weapons touch, they merge into a stronger weapon and deal
                  damage to the boss!
                </li>
                <li>
                  <strong className="text-white">Watch Your Slides:</strong> Every swipe consumes a
                  slide. If you run out of slides before the boss dies, the run is over.
                </li>
                <li>
                  <strong className="text-white">Roll the D20:</strong> Every 5 slides, fate
                  intervenes. You will be forced to roll a D20. High rolls grant buffs; low rolls
                  spawn hazards!
                </li>
                <li>
                  <strong className="text-white">Use Your Spells:</strong> If your class has a spell
                  (like Fireball or Smite), don't forget to use it when the grid gets crowded.
                </li>
                <li>
                  <strong className="text-white">Shop Smart:</strong> After defeating a boss, spend
                  your Gold at the Tavern on Artifacts that passively buff your entire run.
                </li>
              </ul>
            </div>
          )}
          ...
          {currentPage === 2 && (
            <div className="animate-in fade-in slide-in-from-right-4 duration-300">
              ...
              <p className="mb-4">
                <strong>Crit 2048</strong> is a roguelike dungeon crawler built on the 2048 sliding
                puzzle. The grid is your battlefield. Sliding matching weapons merges them and deals
                damage to the boss.
              </p>
              <div className="bg-slate-950 p-4 rounded-xl border border-slate-800 font-mono text-xs mb-4 text-emerald-400">
                Dagger (2) + Dagger (2) = Longsword (4) &rarr; 8 dmg
                <br />
                Longsword + Longsword = Crossbow (8) &rarr; 20 dmg
                <br />
                Crossbow + Crossbow = Battleaxe (16) &rarr; 50 dmg
                <br />
                Battleaxe + Battleaxe = Magic Staff (32) &rarr; 120 dmg
                <br />
                Magic Staff + Magic Staff = Holy Sword (64) &rarr; 300 dmg
                <br />
                Holy Sword + Holy Sword = Relic (128) &rarr; 1,280 dmg
              </div>
              <p className="mb-4">
                Damage is calculated as: <code>weapon_base_dmg &times; your_multiplier</code>. Build
                your multiplier to delete bosses in a single merge.
              </p>
            </div>
          )}
          ...
          {currentPage === 5 && (
            <div className="animate-in fade-in slide-in-from-right-4 duration-300">
              <h3 className="text-xl font-bold text-white mb-3 uppercase tracking-widest border-b border-slate-700 pb-2">
                V. The D20 & Multiplier
              </h3>
              <p className="mb-3">
                Every 5 slides, you must roll the D20. Your class modifier applies.
              </p>
              <table className="w-full text-xs text-left text-slate-400 mb-4 bg-slate-950 rounded-xl border border-slate-800 overflow-hidden">
                <thead className="bg-slate-900 text-white uppercase">
                  <tr>
                    <th className="p-2 border-b border-slate-700">Roll</th>
                    <th className="p-2 border-b border-slate-700">Outcome</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    <td className="p-2 border-b border-slate-800 text-rose-400 font-bold">
                      20+ (Nat 20)
                    </td>
                    <td className="p-2 border-b border-slate-800">
                      CRIT - Mult +1 & upgrade a tile
                    </td>
                  </tr>
                  <tr>
                    <td className="p-2 border-b border-slate-800 text-emerald-400 font-bold">
                      10-19
                    </td>
                    <td className="p-2 border-b border-slate-800">SUCCESS - A Crossbow spawns</td>
                  </tr>
                  <tr>
                    <td className="p-2 border-b border-slate-800 text-amber-400 font-bold">2-9</td>
                    <td className="p-2 border-b border-slate-800">MISS - A Slime spawns</td>
                  </tr>
                  <tr>
                    <td className="p-2 text-red-500 font-bold">1 or less</td>
                    <td className="p-2">FAIL - Your best weapon breaks</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          {currentPage === 6 && (
            <div className="animate-in fade-in slide-in-from-right-4 duration-300">
              ...
              <p className="text-xs mb-3">
                After a boss, visit the Tavern to spend Gold on upgrades.
              </p>
        ...
        <div className="flex justify-between items-center mt-4 pt-4 border-t border-slate-800 shrink-0">
          <button
            onClick={prevHelpPage}
            disabled={currentPage === 1}
            className="px-4 py-2 bg-slate-800 hover:bg-slate-700 text-slate-300 rounded-lg transition-colors font-bold disabled:opacity-50"
          >
            Previous
          </button>
          ...
          <button
            ...
            className="px-4 py-2 bg-rose-600 hover:bg-rose-500 text-white rounded-lg transition-colors font-bold disabled:opacity-50"
          >
            Next
          </button>
        </div>
