    ...
    <div className="absolute inset-0 z-[200] flex items-center justify-center p-6">
      ...
      >
        ...
        <div className="p-8 text-center bg-gradient-to-b from-rose-500/10 to-transparent">
          ...
          <h2 className="text-2xl font-black text-white uppercase tracking-tighter mb-2 font-serif">
            Install Crit 2048
          </h2>
          <p className="text-slate-400 text-xs font-bold uppercase tracking-widest leading-relaxed">
            Add to your home screen to enable <span className="text-rose-400">offline play</span>{' '}
            and fullscreen mode.
          </p>
        </div>
        ...
        <div className="px-8 pb-8 space-y-6">
          <div className="flex items-start gap-4">
            <div className="w-8 h-8 bg-slate-800 rounded-full flex items-center justify-center shrink-0 text-xs font-black text-white border border-slate-700">
              1
            </div>
            <div>
              <p className="text-sm text-slate-200 leading-tight">
                Tap the{' '}
                <span className="inline-flex items-center justify-center bg-slate-800 w-6 h-6 rounded mx-1 text-blue-400">
                  📤
                </span>{' '}
                <strong>Share</strong> button in the Safari menu bar.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <p className="text-sm text-slate-200 leading-tight">
                ...
                <span className="inline-flex items-center justify-center bg-slate-800 w-6 h-6 rounded mx-1 text-slate-400">
                  ➕
                </span>
              </p>
            </div>
