    ...
    >
      <div className="flex justify-between items-center mb-8 shrink-0 pt-4">
        ...
        <div className="text-center flex-grow">
          <h2 className="text-4xl md:text-5xl font-black text-white mb-1 font-serif tracking-tighter uppercase">
            Choose Your Hero
          </h2>
          <p className="text-slate-500 text-[10px] uppercase tracking-[0.3em] font-bold">
            Select a class to begin your descent
          </p>
        </div>
      ...
      >
        {activeClasses.length === 0 && (
          <div className="col-span-full text-center py-20">
            ...
            <p className="text-[10px] text-slate-700 mt-2 font-mono italic">
        ...
        {activeClasses.map((hero: any, idx: number) => (
          <motion.button
            ...
            onKeyDown={(e) => {
              if (e.key === 'Enter') handleSelect(hero);
            }}
            className={clsx(
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-xs text-slate-400 leading-relaxed font-medium">{hero.desc}</p>
            </div>
              ...
              <div className="flex flex-col text-right">
                ...
                <span
                  className={clsx(
                    ...
                    hero.d20Mod >= 0 ? 'text-emerald-400' : 'text-rose-500',
                  )}
                >
