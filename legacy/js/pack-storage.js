...
(function () {
  ...
  async function getPacksDir() {
    ...
    try {
      await invoke('plugin:fs|mkdir', { path: dir, recursive: true });
    } catch (e) {}
    return dir;
  }
  ...
  const PackStorage = {
      ...
      if (isTauri()) {
        try {
          ...
          await invoke('plugin:fs|write_file', {
            path: filePath,
            data: Array.from(enc.encode(dataStr)),
          });
          return true;
        } catch (e) {
    ...
    async load(id) {
      ...
      if (id === 'crit2048-default' && typeof CRIT2048_DEFAULT_PACK !== 'undefined')
        return CRIT2048_DEFAULT_PACK;
      if (id === 'crit2048-default-enemies' && typeof CRIT2048_DEFAULT_ENEMIES_PACK !== 'undefined')
        return CRIT2048_DEFAULT_ENEMIES_PACK;
      if (id === 'crit2048-default-classes' && typeof CRIT2048_DEFAULT_CLASSES_PACK !== 'undefined')
        return CRIT2048_DEFAULT_CLASSES_PACK;
      if (
        id === 'crit2048-default-artifacts' &&
        typeof CRIT2048_DEFAULT_ARTIFACTS_PACK !== 'undefined'
      )
        return CRIT2048_DEFAULT_ARTIFACTS_PACK;
      if (id === 'crit2048-default-weapons' && typeof CRIT2048_DEFAULT_WEAPONS_PACK !== 'undefined')
        return CRIT2048_DEFAULT_WEAPONS_PACK;
      if (id === 'crit2048-default-hazards' && typeof CRIT2048_DEFAULT_HAZARDS_PACK !== 'undefined')
        return CRIT2048_DEFAULT_HAZARDS_PACK;
      if (id === 'crit2048-default-skin' && typeof CRIT2048_DEFAULT_SKIN_PACK !== 'undefined')
        return CRIT2048_DEFAULT_SKIN_PACK;
