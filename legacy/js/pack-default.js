  ...
  enemies: [
    {
      ...
      primaryAbility: {
        ...
        effect: 'spawn_hazard',
        effectParam: 'goblin',
        logMessage: 'Ambush: Goblin spawned!',
      },
    },
    {
      id: 'orc_brute',
      ...
      passiveAbility: {
        ...
        effectParam: 10,
        logMessage: 'Orc Brute resists ${amount} damage!',
      },
    },
    {
      id: 'mimic_colony',
      ...
      primaryAbility: {
        ...
        effect: 'spawn_hazard',
        effectParam: 'mimic',
        logMessage: 'Shapechanger: Mimic spawned!',
      },
    },
    {
      id: 'slime_king',
    ...
    },
    {
      ...
      primaryAbility: {
        trigger: 'every_n_slides',
        triggerParam: 10,
        effect: 'weapon_destroy',
        effectParam: 'worst',
        logMessage: 'Owlbear crushes your weakest weapon!',
      },
    },
    {
      id: 'troll_king',
    ...
    },
    {
      ...
      primaryAbility: {
        ...
        effect: 'tile_shuffle',
        effectParam: 4,
        logMessage: 'Mind Blast: Tiles shuffled!',
      },
    },
    {
      id: 'the_lich',
      ...
      primaryAbility: {
        ...
        triggerParam: 12,
        effect: 'spawn_hazard',
        effectParam: 'skeleton',
        logMessage: 'Necromancy: Skeleton raised!',
      },
    },
    {
      id: 'beholder',
      ...
      primaryAbility: {
        ...
        effect: 'spawn_hazard',
        effectParam: 'web',
        logMessage: 'Eye Ray: Web spawned!',
      },
    },
    {
      id: 'ancient_dragon',
      ...
      primaryAbility: {
        ...
        effect: 'weapon_destroy',
        effectParam: 'best',
        logMessage: 'Inferno burned highest weapon!',
      },
    },
    {
      id: 'vampire_lord',
      ...
      primaryAbility: {
        ...
        effectParam: 'best',
        logMessage: 'Charm: Best weapon degraded!',
      },
    },
    {
      id: 'tiamat',
  ...
  artifacts: [
    {
      ...
      classReq: null,
      basePrice: 15,
      desc: 'D20 rolls < ${4 + lvl} become ${4 + lvl}.',
      scripts: {
        onD20:
          "if (roll.val < 4 + lvl) { roll.val = 4 + lvl; G.log('🎲 Weighted Dice: Roll bumped to ' + roll.val + '!'); }",
      },
    },
    {
      id: 'ASSASSIN_MARK',
      ...
      classReq: 'Rogue',
      basePrice: 20,
      desc: 'Merging Daggers gives +${(0.1 * lvl).toFixed(1)} Mult.',
    },
    {
      id: 'GRAVITY_BOOTS',
      name: 'Gravity Boots',
      ...
      classReq: null,
      basePrice: 10,
      desc: 'Slide DOWN deals ${1 + 0.5 * lvl}x Dmg, UP deals 0.5x.',
      scripts: {
        onMergeDamage:
          "if (dir === 'DOWN') { dmg.val *= (1 + 0.5 * lvl); } else if (dir === 'UP') { dmg.val *= 0.5; }",
      },
    },
    {
      id: 'NECRONOMICON',
    ...
    },
    {
      ...
      scripts: {
        onTavern:
          "G.player.addGold(30 * lvl); G.log('💍 Ring of Wealth: +' + (30 * lvl) + ' Gold!');",
      },
    },
    {
      id: 'BOOTS_HASTE',
      ...
      scripts: {
        onEncounterStart:
          "G.addSlides(3 * lvl); G.log('⚡ Boots of Haste: +' + (3 * lvl) + ' slides!');",
      },
    },
    {
      id: 'GIANT_POTION',
    ...
    },
    {
      ...
      classReq: null,
      basePrice: 35,
      desc: '2% chance for ${200 * lvl} True Dmg on slide.',
    },
    {
      id: 'CLOAK_INVIS',
      ...
      classReq: null,
      basePrice: 25,
      desc: 'Hazards spawn rate -${20 * lvl}%',
    },
    {
      id: 'AMULET_PROOF',
      ...
      classReq: null,
      basePrice: 15,
      desc: 'D20 results 1-2 become ${1 + lvl + 1}',
    },
    {
      id: 'FLAME_TONGUE',
      name: 'Flame Tongue',
      ...
      classReq: 'Fighter',
      basePrice: 20,
      desc: 'Merging T3+ deals +${50 * lvl} AOE dmg.',
    },
    {
      id: 'MOON_SICKLE',
      name: 'Moon Sickle',
      ...
      classReq: 'Druid',
      basePrice: 20,
      desc: 'Heal spells restore +${3 * lvl} extra slides.',
    },
    {
      id: 'LUTE_THUNDER',
    ...
    },
    {
      ...
      classReq: 'Sorcerer',
      basePrice: 35,
      desc: 'Chaos Bolt always picks best outcome.',
    },
    {
      id: 'BRACERS_DEF',
      ...
      classReq: 'Monk',
      basePrice: 15,
      desc: '+${2 * lvl} slides per D20 roll.',
    },
    {
      id: 'QUIVER_PLENTY',
      ...
      classReq: 'Ranger',
      basePrice: 15,
      desc: "Hunter's Mark lasts +${2 * lvl} merges.",
    },
    {
      id: 'BAG_HOLDING',
      name: 'Bag of Holding',
      ...
      classReq: null,
      basePrice: 10,
      desc: 'Shop offers +${1 * lvl} artifact slots.',
    },
    {
      id: 'HELM_BRILLI',
    ...
    },
    {
      ...
      classReq: null,
      basePrice: 25,
      desc: 'Immune to crit fail (D20 = 1).',
    },
    {
      id: 'IMMOV_ROD',
      name: 'Immovable Rod',
      ...
      classReq: null,
      basePrice: 15,
      desc: "Hazards can't spawn adjacent to best weapon.",
    },
    {
      id: 'DECK_MANY',
    ...
    },
    {
      ...
      classReq: 'Paladin',
      basePrice: 50,
      desc: 'Smite dmg x${2 * lvl}. Hazards take AOE on cast.',
    },
    {
      id: 'SPELL_SCROLL',
      name: 'Spell Scroll',
