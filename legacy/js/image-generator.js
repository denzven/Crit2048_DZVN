  ...
  const ImageGenerator = {
    ...
    async generate(data, options = {}) {
      ...
      return new Promise((resolve, reject) => {
        ...
        let bgStart = '#1e293b',
          bgEnd = '#020617';
        let accent1 = 'rgba(244, 63, 94, 0.1)',
        ...
        if (theme === 'midnight') {
          bgStart = '#0f172a';
          bgEnd = '#000000';
          accent1 = 'rgba(30, 41, 59, 0.2)';
          accent2 = 'rgba(15, 23, 42, 0.2)';
          primaryColor = '#64748b';
          particleColors = ['#94a3b8', '#ffffff'];
        } else if (theme === 'golden') {
          bgStart = '#451a03';
          bgEnd = '#0c0a09';
          accent1 = 'rgba(251, 191, 36, 0.15)';
          ...
          bgStart = '#083344';
          bgEnd = '#020617';
          accent1 = 'rgba(34, 211, 238, 0.2)';
          accent2 = 'rgba(192, 38, 211, 0.2)';
          primaryColor = '#22d3ee';
          particleColors = ['#22d3ee', '#c026d3', '#ffffff'];
        } else if (theme === 'rose') {
          bgStart = '#4c0519';
          bgEnd = '#020617';
          accent1 = 'rgba(244, 63, 94, 0.25)';
          accent2 = 'rgba(136, 19, 55, 0.25)';
          primaryColor = '#fb7185';
        ...
        ctx.beginPath();
        ctx.roundRect(canvas.width / 2 - 200, 310, 400, 60, 30);
        ctx.fill();
        ...
        if (data.packRunLabel) {
          ...
          ctx.beginPath();
          ctx.roundRect(canvas.width / 2 - 300, 380, 600, 44, 22);
          ctx.fill();
        ...
        ctx.beginPath();
        ctx.roundRect(-300, -130, 600, 260, 48);
        ctx.fill();
        ...
        ctx.beginPath();
        ctx.roundRect(-300, -140, 600, 260, 48);
        ctx.fill();
        ...
        const drawIsoStat = (label, value, x, y, icon = '', color = '#ffffff') => {
          ...
          ctx.beginPath();
          ctx.roundRect(-210, -65, 420, 130, 24);
          ctx.fill();

          ctx.fillStyle = 'rgba(255, 255, 255, 0.03)';
          ctx.beginPath();
          ctx.roundRect(-210, -70, 420, 130, 24);
          ctx.fill();
        ...
        drawIsoStat(
          'Total Damage',
          Math.floor(data.totalDamageDealt).toLocaleString(),
          col2X,
          gridY,
        );
        ...
        drawIsoStat(
          'Spell Damage',
          Math.floor(data.spellDamageDealt).toLocaleString(),
          col1X,
          gridY + rowH * 2,
          '🔥',
        );
