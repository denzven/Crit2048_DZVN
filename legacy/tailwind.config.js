...
module.exports = {
  ...
  content: ['./index.html', './original.html', './js/**/*.js', './js/templates/**/*.js'],
  ...
  safelist: [
    ...
    {
      pattern:
        /^text-(rose|amber|purple|indigo|slate|white|emerald|blue|red)-(400|500|600|700|800|900)$/,
    },
    {
      pattern:
        /^border-(rose|amber|purple|indigo|slate|white|emerald|blue|red)-(400|500|600|700|800|900)$/,
    },
    {
      pattern:
        /^bg-(rose|amber|purple|indigo|slate|white|emerald|blue|red)-(400|500|600|700|800|900|950)$/,
    },
